(function(w, d) {
    ...
    zaraz.pageVariables = {}, zaraz._p = a => {
        ...
        Object.keys(zaraz.pageVariables).forEach((a => r.data[a] = JSON.parse(zaraz.pageVariables[a]))),
            ...
            r.data = { ...r.data,
                ...e
            }, r.zarazData = zarazData, fetch("/cdn-cgi/zaraz/t", {
                credentials: "include",
                keepalive: !0,
                method: "POST",
                headers: {
            ...
            }).catch((() => (console.warn("Large event payload sent to Cloudflare Zaraz, cannot assure deliverability."), fetch("/cdn-cgi/zaraz/t", {
                credentials: "include",
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                ...
                return zarazData._let = (new Date).getTime(), 200 === a.status && a.json()
            })).then((function(a) {
                zaraz._p(a), "function" == typeof t && t()
            }))
    }, zaraz.set = function(a, e, t) {
        e = JSON.stringify(e), prefixedKey = "_zaraz_" + a, sessionStorage.removeItem(prefixedKey), localStorage.removeItem(prefixedKey), delete zaraz.pageVariables[a], t && "session" == t.scope ? sessionStorage.setItem(prefixedKey, e) : t && "page" == t.scope ? zaraz.pageVariables[a] = e : localStorage.setItem(prefixedKey, e), zaraz.__watchVar = {
            key: a,
            value: e
        }
    };
    ...
    window.dataLayer = w.dataLayer || [], zaraz._processDataLayer = a => {
        if (a.event) {
            ...
            let e = {};
            for (obj of dataLayer.slice(0, dataLayer.indexOf(a) + 1)) e = { ...e,
                ...obj
            };
    ...
    history.pushState = function() {
        History.prototype.pushState.apply(history, arguments), zarazData.l = d.location.href, zarazData.t = d.title, zaraz.track("__zarazSPA"), zaraz.pageVariables = {}
    }, history.replaceState = function() {
        History.prototype.replaceState.apply(history, arguments), zarazData.l = d.location.href, zarazData.t = d.title, zaraz.track("__zarazSPA"), zaraz.pageVariables = {}
    };
    zaraz._p({
        "f": [],
